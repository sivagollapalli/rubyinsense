# RailsAdmin config file. Generated on June 28, 2013 18:51
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Rubyinsense', 'Admin']
  ...
  # config.excluded_models = ['Question', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Question', 'User']
